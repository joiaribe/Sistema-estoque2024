...
$autoloadManager->addFolder(__DIR__ . '/Inbox/');
$autoloadManager->register();

use Developer\Tools\Url as Url;
use notifier\Inbox\InboxAutoload as InboxAutoload;

class InboxModel extends InboxAutoload{
    ...
    private function pre_configure_widget_breadcrumb_actions() {
        $names = array(
            ...
            'Caixa de Entrada' => array(
                'link' => 'Notifier/' . $this->page,
                'icon' => NULL
            ),
            $this->_capture_name_widget_breadrumb_action() . ' Mensagem ' => array(
                'link' => NULL,
                'icon' => NULL
            ),
        );
