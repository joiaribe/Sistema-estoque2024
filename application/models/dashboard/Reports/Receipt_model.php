...
$autoloadManager->addFolder(__DIR__ . '/Receipt/');
$autoloadManager->register();

use Developer\Tools\Url as Url;
use Manager\Receipt\ReceiptAutoload as ReceiptAutoload;

/**
 * Main Class
 */
class ReceiptModel extends ReceiptAutoload {
    ...
    private function pre_configure_widget_breadcrumb_actions() {
        $names = array(
            ...
            'Listar Recibos ' => array(
                'link' => 'Reports/' . $this->page,
                'icon' => NULL
            ),
            $this->_capture_name_widget_breadrumb_action() . ' Recibos ' => array(
                'link' => NULL,
                'icon' => NULL
            ),
        );
