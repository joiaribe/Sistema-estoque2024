 ...
 */
class FinanceJavascript extends FinanceConfig {
...
EOF;
     ...
     * @return JS
     */
    protected function MakeTopProducts($data) {
        return print <<<EOF
<script>
...
EOF;
     ...
     * @return JS
     */
    protected function MakeTopServices($data) {
...
$(function() {
        ...
        var plot = $.plotAnimator($("#combine-chart #combine-chartContainer"),
                data, options);
    });
        </script>
EOF;
