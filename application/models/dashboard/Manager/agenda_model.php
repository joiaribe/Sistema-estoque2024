...
$autoloadManager->addFolder(__DIR__ . '/Agenda/');
$autoloadManager->register();

use Developer\Tools\Url as Url;
use Manager\Agenda\AgendaAutoload as AgendaAutoload;

/**
 * Main Class
 */
class AgendaModel extends AgendaAutoload {
    ...
    private function pre_configure_widget_breadcrumb_actions() {
        $names = array(
            ...
            'Gerenciar Agenda ' => array(
                'link' => 'Manager/' . $this->page,
                'icon' => NULL
            ),
            $this->_capture_name_widget_breadrumb_action() . ' Agenda ' => array(
                'link' => NULL,
                'icon' => NULL
            ),
        );
