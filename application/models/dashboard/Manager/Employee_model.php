...
$autoloadManager->addFolder(__DIR__ . '/Employee/');
$autoloadManager->register();

use Developer\Tools\Url as Url;
use Manager\Employee\EmployeeAutoload as EmployeeAutoload;

class EmployeeModel extends EmployeeAutoload{
    ...
    private function pre_configure_widget_breadcrumb_actions() {
        $names = array(
            ...
            $this->_capture_name_widget_breadrumb_action() . ' Funcionário ' => array(
                'link' => NULL,
                'icon' => NULL
            ),
        );
