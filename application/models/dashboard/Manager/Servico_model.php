...
$autoloadManager->addFolder(__DIR__ . '/Servico/');
$autoloadManager->register();

use Developer\Tools\Url as Url;
use Manager\Servico\ServicoAutoload as ServicoAutoload;

class ServicoModel extends ServicoAutoload{
