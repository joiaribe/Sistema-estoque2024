 ...
 */
class FornecedorHTML extends requireds {
    ...
    protected function contain_table(array $fetch) {
        ...
        <tr class="gradeX">
            ...
            <td>{$this->verify_cpf_or_cpnj($fetch['cpnj'], $fetch['cpf'])}</td>
            <td>{$this->check_field($fetch['email'])}</td>
...
EOFPAGE;
     ...
     * @return str
     */
    private function verify_cpf_or_cnpj($cpf, $cpnj) {
        if (isset($cpnj)) {
            return '<tr>
                        <th>CNPJ:</th>
                        <td>' . $cpnj . '</td>
    ...
    private function _make_list_mode_tables(array $param) {
        return '            
            ...
            ' . $this->verify_cpf_or_cnpj($param['cpf'], $param['cpnj']) . '
            <tr>
                <th>Email:</th>
                <td>' . $this->check_field($param['email']) . '</td>
            </tr>
            <tr>
                <th>Telefone:</th>
...
EOF;
    ...
    private function LEFT_ELEMENTS_INSER_NEW() {
        ...
        <div class="col-md-5">        
            <div class="form-group">
                <label for="nome" class="control-label col-md-4">Empresa<span id="field-required">*</span></label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                 <label for="firstname" class="control-label col-lg-4">Telefone<span id="field-required">*</span></label>
                <div class="col-md-6">
                         <input type="text" name="tel" data-mask="(99) 999-9999" class="form-control" required>
                </div>
            </div>  
            <div class="form-group">
                 <label for="firstname" class="control-label col-lg-4">E-mail<span id="field-required">*</span></label>
                <div class="col-md-6">
                        <input class="form-control" id="cemail" type="email" name="email" required/>
                </div>
            </div> 
            <div class="form-group">
                 <label for="firstname" class="control-label col-lg-4">Indentificaçao<span id="field-required">*</span></label>
                <div class="col-md-6">
                       <input type="checkbox" id="icheck" name="icheck" checked data-on-label="CPF" data-off-label="CNPJ">
                </div>
            </div> 
            <div class="form-group box-cpf">
                 <label for="firstname" class="control-label col-lg-4">CPF<span id="field-required">*</span></label>
                <div class="col-md-6">
                      <input type="text" name="CPF" data-mask="999.999.999-99" class="form-control">
                </div>
            </div>
            <div class="form-group box-cnpj">
                 <label for="firstname" class="control-label col-lg-4">CNPJ<span id="field-required">*</span></label>
                <div class="col-md-6">
                    <input type="text" name="cpnj" data-mask="99.999.999-9" class="form-control">
                </div>
            </div>  
</div>
EOF;
    ...
    private function LEFT_ELEMENTS_Update($data) {
        ...
        <div class="col-md-5">        
            <div class="form-group">
                <label for="nome" class="control-label col-md-4">Empresa<span id="field-required">*</span></label>
                <div class="col-md-6">
                    <input value="{$data['empresa']}" class="form-control" id="cname" name="name" minlength="2" type="text" required />
                </div>
            </div>
            ...
            <div class="form-group">
                 <label for="firstname" class="control-label col-lg-4">Telefone<span id="field-required">*</span></label>
                <div class="col-md-6">
                         <input value="{$data['fone']}" type="text" name="tel" data-mask="(99) 999-9999" class="form-control" required>
                </div>
            </div>  
            <div class="form-group">
                 <label for="firstname" class="control-label col-lg-4">E-mail<span id="field-required">*</span></label>
            ...
            <div class="form-group">
                 <label for="firstname" class="control-label col-lg-4">Indentificaçao<span id="field-required">*</span></label>
                <div class="col-md-6">
                       <input type="checkbox" id="icheck" name="icheck" {$this->_check_checked('on', $data['cpf'])} data-on-label="CPF" data-off-label="CNPJ">
                </div>
            </div> 
            <div class="form-group box-cpf">
                 <label for="firstname" class="control-label col-lg-4">CPF<span id="field-required">*</span></label>
            ...
            <div class="form-group box-cnpj">
                 <label for="firstname" class="control-label col-lg-4">CNPJ<span id="field-required">*</span></label>
                <div class="col-md-6">
                    <input value="{$data['cpnj']}" type="text" name="cpnj" data-mask="99.999.999-9" class="form-control">
                </div>
            </div>  
</div>
EOF;
 ...
 */
class requireds extends FornecedorConfig {
