...
new menu($filename);
// loaded breadcrumb
new ProductsModel('action');  // used param for load class only here :P
new breadcrumb($filename, array('Movimentar' => array('link' => false, 'icon' => false), 'Venda Produtos' => NULL));
...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">Movimentar Vendas de Produtos
...
<div class="modal fade" id="myModalBillet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="panel-body">
                    <?php new ProductsModel('load_element', 'loadModalBillet') ?>
                </div>
            </div>
            <div class="modal-footer">
