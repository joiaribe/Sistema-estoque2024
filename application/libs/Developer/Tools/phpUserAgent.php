...
class phpUserAgent {
    ...
    public function __construct($userAgentString = null, UseAgent\phpUserAgentStringParser $userAgentStringParser = null) {
    ...
    public function configureFromUserAgentString($userAgentString, phpUserAgentStringParser $userAgentStringParser = null) {
        if (null === $userAgentStringParser) {
            $userAgentStringParser = new UseAgent\phpUserAgentStringParser();
        }
