 ...
 *  <li><b>image_tint_color</b> if set, will tint the image with a color, value as hexadecimal #000000 (default: NULL)<br>
 *  <pre>$handle->image_tint_color = '#FF0000';</pre></li>
 *  <li><b>image_overlay_color</b> if set, will add a colored overlay, value as hexadecimal #000000  (default: NULL)<br>
 ...
 *  <li><b>image_text_color</b> text color for the text label, in hexadecimal (default: #000000 )<br>
 ...
 *  <li><b>image_bevel_color1</b> top and left bevel color, in hexadecimal (default: #000000 )<br>
 *  <pre>$handle->image_bevel_color1 = '#000000 ';</pre></li>
 ...
 *  <li><b>image_border_color</b> border color, in hexadecimal (default: #000000 )<br>
 *  <pre>$handle->image_border_color = '#000000 ';</pre></li>
 *  <li><b>image_frame</b> type of frame: 1=flat 2=crossed (default: NULL)<br>
 *  <pre>$handle->image_frame = 2;</pre></li>
 *  <li><b>image_frame_colors</b> list of hex colors, in an array or a space separated string (default: '#000000 #999999 #666666 #000000')<br>
 ...
 *  <li><b>image_reflection_color</b> reflection background color, in hexadecimal (default: #000000)<br>
...
class Upload {
     ...
     *
     * Value is an hexadecimal color, such as #000000
     *
     * Default value is NULL
     *
     * @access public
     ...
     * For instance, are valid:
     * <pre>
     * $foo->image_frame_colors = '#000000 #999999 #666666 #000000';
     * $foo->image_frame_colors = array('#000000', '#999999', '#666666', '#000000');
     * </pre>
     *
     * This setting is used only if {@link image_frame} is set
     *
     * Default value is '#000000 #999999 #666666 #000000'
     *
     * @access public
     * @var string OR array;
     */
    ...
    function init() {
        ...
        $this->image_reflection_color = '#000000';
        ...
        $this->image_bevel_color1 = '#000000';
        $this->image_bevel_color2 = '#000000';
        $this->image_border = NULL;
        $this->image_border_color = '#000000';
        $this->image_frame = NULL;
        $this->image_frame_colors = '#000000 #999999 #666666 #000000';
    ...
    function create_image($x, $y, $image) {
        ...
        if (!empty($this->image_background_color)) {
            ...
            if (is_resource($image))
                imagecolortransparent($image, imagecolorexact($image, 0, 0, ($blue == 0 ? 255 : 0)));
        }
                ...
                if ($this->processed && $image_src) {
                    ...
                    if (!empty($this->image_text)) {
                        ...
                        $this->image_text = str_replace(
                            ...
                            $_SERVER['HTTP_HOST'],
                            $_SERVER['SERVER_NAME'],
                            $_SERVER['REMOTE_ADDR']), $this->image_text);
