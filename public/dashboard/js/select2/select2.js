...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatMatches: function (matches) {
            return matches + " resultados estão disponíveis, use cima e para baixo teclas de setas para navegar.";
        },
        ...
        formatInputTooShort: function (input, min) {
            ...
            return "Por favor insira " + n + " ou mais caracteres" + (n == 1 ? "" : "s");
        },
        ...
        formatSelectionTooBig: function (limit) {
            return "Você só pode selecionar " + limit + " item" + (limit == 1 ? "" : "s");
        },
