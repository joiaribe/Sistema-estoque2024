...
(function ($) {
    $.fn.smartCart = function (options) {
        ...
        return this.each(function () {
            ...
            var labelCartMenuNameTooltip = "Carrinho | Total de produtos: _PRODUCTCOUNT_ | Quantidade Total: _ITEMCOUNT_";
            ...
            var messageProductEmpty = "Não há produtos para mostrar";
            var messageProductAddError = "O produto não pode adicionar";
            var messageItemAdded = 'O produto foi adicionado ao carrinho';
            var messageItemRemoved = 'Produto removido do carrinho';
            var messageQuantityUpdated = 'Quantidade produto atualizada';
            var messageQuantityErrorAdd = 'Quantidade inválida. Não foi possivel adicionar o produto';
    ...
    $.fn.smartCart.defaults = {
        ...
        productItemTemplate: '<strong><%=pname%></strong><br />Marcador: <%=pcategory%><br /><small><%=pdesc%></small><br /><strong>Preço: <%=pprice%></strong>',
